...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9">
                    <form class="row contact_form" action="${contextPath }/blog/blogWrite" method="post" enctype="multipart/form-data">
                        <div class="col-md-6">
                            ...
                            <div>
                            	...
                            	<input type="file" class="form-control" name="picture1" value="파일 선택" required="required">
                            	<input type="text" class="form-control" placeholder="상단 메인에 업로드 할 이미지 파일을 선택해주세요." readonly="readonly">
                            	<input type="file" class="form-control" name="picture2" value="파일 선택" required="required">
                            	<input type="text" class="form-control" placeholder="서브에 업로드 할 이미지 파일을 선택해주세요." readonly="readonly">
                            	<input type="file" class="form-control" name="picture3" value="파일 선택" required="required">
                            	<input type="text" class="form-control" placeholder="서브에 업로드 할 이미지 파일을 선택해주세요." readonly="readonly">
                            <div>
                            	<br>
                            </div>
